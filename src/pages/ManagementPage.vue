    ...
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        ...
        <div>
          ...
          <button @click="selectrestaurantform = !selectrestaurantform">選擇餐廳</button>
          <br><br/>
          ...
          <form @submit.prevent="restaurantselect" style="align-items: center;">
            ...
            <input type="text" id="restaurant" name="restaurant" :is="restaurant" required placeholder=""/><br/>
            <label for="memu">菜單URL</label><br/>
            <input type="text" id="memu" name="memu" :is="memu" required placeholder="https://....."/><br/><br>
